...
@Slf4j
public class InterviewStepCreatedMailDelegate implements JavaDelegate {
    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        notifyService.sendMessage("Interview process " + delegateExecution.getProcessDefinitionId() + ": step created");
